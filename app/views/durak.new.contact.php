	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb animated fadeIn">
				<div class=" pull-left">
					<div class="page-title"><strong style="font-weight: 600;" >Yeni Kişi Ekle</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                     ...
                     <li class="active">Yeni Kişi</li>
                 </ol>
             </div>
         </div>

         <div class="alert alert-success animated fadeIn">
            <center><strong>Rehberinize eklediğiniz kişiler artık tek bir mesaj ile taksi çağırabilirler.</strong></center>
        </div>
        ...
        <div style="font-size: 20px;" class="row animated fadeIn">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>Rehbere yeni kişi ekle</header>
                    </div>
                                ...
                                <div class="form-group row  margin-top-20">
                                    ...
                                    <div class="form-group row  margin-top-20">
                                        ...
                                        <div class="form-group row  margin-top-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea placeholder="Adres" class="form-control" name="adres"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="offset-md-3 col-md-9">
                                            <button type="submit" class="btn btn-success">Kişiyi Rehbere Ekle</button>
