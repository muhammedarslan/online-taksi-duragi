...
<html lang="tr">
<head>
	<title>Şifrenizi Sıfırlayın | Online Taksi Durağı</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="/DurakYonetim/Giris/Post2" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Bu alan zorunludur">
						<input id="TlfMask" class="input100" type="password" name="pass">
						<span class="focus-input100"></span>
						<span class="label-input100">Yeni şifrenizi belirleyin</span>
					</div>
