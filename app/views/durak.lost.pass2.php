	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="/DurakYonetim/Giris/Post" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100">
						<input style="letter-spacing: 34px;
						text-align: center;
						font-size: 30px;
						font-weight: 600;" required="" class="input100" autocomplete="off" type="text" name="pin" minlength="6" maxlength="6" >
						<span class="focus-input100"></span>
						<span class="label-input100">Telefonunuza gelen pin numarası</span>
					</div>
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="/DurakYonetim/Giris?Sifremi=Unuttum" class="txt1">
								Yeni kod gönder
							</a>
						</div>
					</div>			
					...
					<div onclick="send_form();" class="container-login100-form-btn">
