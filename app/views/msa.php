...
<html lang="tr">
<head>
	<title>Hesabı Aktifleştir</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<form action="javascript:;" method="post" id="step_form" novalidate="" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Bu alan zorunludur">
						...
						<input class="input100" type="text" name="bir" placeholder="Referans paneliniz için kullanıcı adı.">
						<span class="focus-input100"></span>
					</div>
					<input type="text" hidden="" value="step1" name="step">

					<div class="wrap-input100 validate-input m-b-26" data-validate="Bu alan zorunludur">
						<span class="label-input100">Sms User</span>
						<input class="input100" type="text" name="iki" placeholder="Referans paneliniz için kullanıcı adı.">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-26" data-validate="Bu alan zorunludur">
						<span class="label-input100">Sms Pass</span>
						<input class="input100" type="text" name="uc" placeholder="Referans paneliniz için kullanıcı adı.">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-26" data-validate="Bu alan zorunludur">
						<span class="label-input100">Sms Title</span>
						<input class="input100" type="text" name="dort" placeholder="Referans paneliniz için kullanıcı adı.">
						<span class="focus-input100"></span>
					</div>
				...
				<a style="    float: right;
				margin-top: -50px;
				margin-right: 30px;" href="/YeniRef">Hesabınız yok mu? Kayıt olun.</a>
			</div>
		</div>
	</div>
